  ...
  return `<section class="about-page">
    <header class="about-masthead">
      <div class="about-identity">
        ...
        <h1>${getLocale().startsWith('zh') ? t('about.realName') : t('home.name')}</h1>
        <p class="about-alias">${getLocale().startsWith('zh') ? 'SHIXI LIN' : t('about.realName')}</p>
        <dl class="about-names">
          <div><dt>${t('about.penNameLabel')}</dt><dd>光之十一</dd></div>
