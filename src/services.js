  ...
  return `<section class="services-page">
    ...
    <ol class="service-directory">
      ${services.map((service, index) => `<li class="service-item">
        ...
        <p>${copy(`services.${service}.text`)}</p>
      </li>`).join('')}
    </ol>
